      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="/dashboard/quantvue" className="block p-6 bg-white rounded-xl shadow-sm hover:shadow-md border-2 border-cyan-300">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-medium text-cyan-600 bg-cyan-50 px-2 py-1 rounded-full">NEW</span>
          </div>
          <h3 className="text-lg font-medium text-gray-900 mb-2">QuantVue</h3>
          <p className="text-sm text-gray-500">Multi-model quantitative research framework.</p>
        </a>
        ...
        {/* 7. BlackWatch — Global Intelligence Signal Board */}
        <a href="/dashboard/blackwatch" className="block p-6 bg-white rounded-xl shadow-sm hover:shadow-md border-2 border-slate-800">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-medium text-slate-700 bg-slate-100 px-2 py-1 rounded-full">LIVE</span>
          </div>
          <h3 className="text-lg font-medium text-gray-900 mb-2">BlackWatch</h3>
          <p className="text-sm text-gray-500">Global intelligence signal board — 20 domains, convergence detection.</p>
        </a>
      </div>
    </div>
  )
